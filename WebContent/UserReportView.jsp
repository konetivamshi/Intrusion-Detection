<!DOCTYPE html>
<%@page import="com.Intrusion.PojoClass.UserReportPojo"%>
<%@page import="com.Intrusion.Servlet.UserDailyReport"%>
...
<section id="content"><div class="ic">More Website Templates @ TemplateMonster.com - July 28, 2014!</div>
  <div class="container">
    <div class="row">
      <div class="grid_12">
        <center><h3><span>Project Details</span></h3> </center>
        <div class="blog">
          ...
          <tr>
          <th> Date</th>  <th> Project Name</th> <th>User Name</th><th>Report</th></tr>
          <%
          
          String sess= (String)session.getAttribute("secreat");
 			      
 		 Interfce mi=new DaoImplementation();
 		 mi.UpdateUserReportView(sess);

          List list=mi.UserReportView();
         
           Iterator it=list.iterator();
           while(it.hasNext())
           {
        	  UserReportPojo pojo=(UserReportPojo)it.next();
        	String date=pojo.getDate();
        	String pname=pojo.getProjectname();
        	String uname=pojo.getUsername();
        	String report=pojo.getReport();
        	%>
        	<tr>
        	<td><%=date %></td>
