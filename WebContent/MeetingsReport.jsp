...
<section id="content"><div class="ic">More Website Templates @ TemplateMonster.com - July 28, 2014!</div>
  <div class="container">
    <div class="row">
      <div class="grid_12">
       <center> <h3><span>Meeting  Report </span></h3> </center>
        <div class="blog">
     ...
     <form action="MeetingReport" method="post">
...
<p><input type="text" name="date" id="demo1"   maxlength="25" size="25" required value="DATE" onBlur="if(this.value=='')this.value='DATE'" onFocus="if(this.value=='DATE')this.value='' "/> <img src="images/cal.gif" onclick="javascript:NewCssCal('demo1')" style="cursor: pointer" /></p>
           ...
           <input type="text" name="team" id="team"   maxlength="25" size="15" required value="TEAM NAME" onBlur="if(this.value=='')this.value='TEAM NAME'" onFocus="if(this.value=='TEAM NAME')this.value='' "/>
           <input type="text" name="module" id="module"   maxlength="25" size="15" required value="MODULE" onBlur="if(this.value=='')this.value='MODULE'" onFocus="if(this.value=='MODULE')this.value='' "/>
           <input type="text" name="queries" id="queries"   maxlength="25" size="15" required value="QUERIES" onBlur="if(this.value=='')this.value='QUERIES'" onFocus="if(this.value=='QUERIES')this.value='' "/>
           <input type="text" name="conclusion" id="conclusion"   maxlength="25" size="15" required value="CONCLUSION" onBlur="if(this.value=='')this.value='CONCLUSION'" onFocus="if(this.value=='CONCLUSION')this.value='' "/></BR>
