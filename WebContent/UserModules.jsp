<!DOCTYPE html>
<%@page import="com.Intrusion.PojoClass.UserUploadPojo"%>
    ...
    <div class="row">
      <div class="grid_12">
        ...
        <div class="blog">
          ...
          <tr>
          <th> Employee Id</th>  <th> File name</th> <th>Path</th><th>File</th></tr>
          <%
          String sess= (String)session.getAttribute("secreat");
		      
  		 Interfce mi=new DaoImplementation();
         mi.UpdateUserModulesView(sess);
         
          List list=mi.UserModulesView();
         
           Iterator it=list.iterator();
           while(it.hasNext())
           {
        	  UserUploadPojo pojo=(UserUploadPojo)it.next();
        	String userid=pojo.getUsername();
            ...
            <td><%=filename %></td>
            <td><%=path %></td>
        	<td><a href="UserDownload?fname=<%=filename%>" >Download</a></td>
