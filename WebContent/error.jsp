...
<p><input type="text" required value="Password" name="Password" onBlur="if(this.value=='')this.value='Password'" onFocus="if(this.value=='Password')this.value='' "></p>
<p><input type="text" required value="Email Address" name="email" onBlur="if(this.value=='')this.value='Email Address'" onFocus="if(this.value=='Email Address')this.value='' "></p>
<p><input type="text" required value="Designation" name="designation" onBlur="if(this.value=='')this.value='Designation'" onFocus="if(this.value=='Designation')this.value='' "></p>
<p><input type="text" required value="phone"  name="phone" onBlur="if(this.value=='')this.value='phone'" onFocus="if(this.value=='phone')this.value='' "></p>
<p><input type="text" name="dob" id="demo1"  name="dob" maxlength="25" size="25" required value="DOB" onBlur="if(this.value=='')this.value='DOB'" onFocus="if(this.value=='DOB')this.value='' "/> <img src="images/cal.gif" onclick="javascript:NewCssCal('demo1')" style="cursor: pointer" /></p>
<p><input type="text" required value="Address" name="address" onBlur="if(this.value=='')this.value='Address'" onFocus="if(this.value=='Address')this.value='' "></p>
<p><input type="submit" value="Login"></p>
</fieldset>
</form>
</div> <!-- end login -->
