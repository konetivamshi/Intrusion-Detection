    ...
    <div class="row">
      <div class="grid_12">
        ...
        <div class="blog">
          ...
          <tr>
          <th> Domain Name</th>  <th> File name</th> <th>File</th></tr>
          <%
         
          Interfce mi=new DaoImplementation(); 
          List list=mi.getProect();
         
           Iterator it=list.iterator();
           while(it.hasNext())
           {
        	  ManagerUploadPojo pojo=(ManagerUploadPojo)it.next();
        	String domain=pojo.getDomain().toString();
            ...
            <td><%=filename %></td>
        	<td><a href="ProjectDownload?fname=<%=filename%>" >Download</a></td>
